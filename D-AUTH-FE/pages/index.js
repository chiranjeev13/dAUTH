...
export default function RouteName() {
  ...
  <p>
    ...
    <b>Zero Knowledge based Blockchain Technology</b>{" "}
            ...
            <div className="flex flex-col md:flex-row gap-10">
              ...
              <div class="px-6 py-4">
                  <div class="font-bold text-lg mb-2">Upload Information</div>
              ...
              <div class="max-w-sm rounded overflow-hidden shadow-lg">
                <div class="flex justify-center w-full h-1/3">
                  <Image width="200px"
              height="200px" width="50px" src={veriImage} alt="SImage" />
                </div>
                <div class="px-6 py-4">
  ...
  <a
    href="/upload"
    className="box-border relative z-30 inline-flex items-center justify-center w-auto px-8 py-3 overflow-hidden font-bold text-white transition-all duration-300 bg-gradient-to-r from-orange-500 to-orange-600 rounded-md cursor-pointer group ring-offset-2 ring-1 ring-orange-300 ring-offset-orange-200 hover:ring-offset-orange-500 ease focus:outline-none"
  >
